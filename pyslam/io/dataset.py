...
class Dataset(object):
    ...
    def getImageFilename(self):
            """Return the basename (without path) of the last-read image/video frame, if available."""
            return getattr(self, "_img_filename", None)
...
class VideoDataset(Dataset):
    def __init__(
        ...
        self._img_filename = None  # store last image's basename
    ...
    def getImage(self, frame_id):
        ...
        self._img_filename = f"{self._timestamp:.6f}"  # e.g., '1668016698.917979'
        return np.ascontiguousarray(image)
    
    
    def getImageFilename(self, frame_id=None):
            # return last-read basename
...
class FolderDataset(Dataset):
    ...
    def getImage(self, frame_id):
        ...
        #NEW: Extract the actual filename (with extension)
        img_filename = os.path.basename(image_file)  # e.g., 'frame_001.png'
